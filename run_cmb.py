...
# 1. DEFINE YOUR CUSTOM MATH RIGHT IN THE RUNNER
...
# 2. REGISTER THE CLASS WITH CAMB
camb.baseconfig.cp.set_classes(LivingToeQuintessence=LivingToeQuintessence)

# 3. DEFINE THE SUPERCOMPUTER CONFIGURATION IN PYTHON
info = {
    "theory": {
        "camb": {
            "extra_args": {
