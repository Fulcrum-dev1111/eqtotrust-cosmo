...
if os.path.exists("pantheon_plus.csv"):
    print("pantheon_plus.csv already exists, skipping download.")
else:
    ...
    # Extract redshift (zHD), distance modulus (m_b_corr), and diagonal error (m_b_corr_err_DIAG)
